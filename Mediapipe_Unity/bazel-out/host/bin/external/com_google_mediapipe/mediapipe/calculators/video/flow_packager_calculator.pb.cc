...
const uint32_t TableStruct_mediapipe_2fcalculators_2fvideo_2fflow_5fpackager_5fcalculator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::mediapipe::FlowPackagerCalculatorOptions)},
};
...
inline void FlowPackagerCalculatorOptions::SharedCtor() {
cache_file_format_.UnsafeSetDefault(nullptr);
flow_packager_options_ = nullptr;
caching_chunk_size_msec_ = 2500;
}
...
inline void FlowPackagerCalculatorOptions::SharedDtor() {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          caching_chunk_size_msec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* FlowPackagerCalculatorOptions::_InternalSerialize(
...
// @@protoc_insertion_point(message_byte_size_start:mediapipe.FlowPackagerCalculatorOptions)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    // optional int32 caching_chunk_size_msec = 2 [default = 2500];
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_caching_chunk_size_msec());
    }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData FlowPackagerCalculatorOptions::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    FlowPackagerCalculatorOptions::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*FlowPackagerCalculatorOptions::GetClassData() const { return &_class_data_; }

void FlowPackagerCalculatorOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<FlowPackagerCalculatorOptions *>(to)->MergeFrom(
      static_cast<const FlowPackagerCalculatorOptions &>(from));
}
...
void FlowPackagerCalculatorOptions::InternalSwap(FlowPackagerCalculatorOptions* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &cache_file_format_, lhs_arena,
      &other->cache_file_format_, rhs_arena
  );
