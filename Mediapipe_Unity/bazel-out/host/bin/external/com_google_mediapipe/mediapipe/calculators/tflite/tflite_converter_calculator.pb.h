...
class TfLiteConverterCalculatorOptions_TensorFloatRange final :
 ...
 public:
  ...
  TfLiteConverterCalculatorOptions_TensorFloatRange* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class TfLiteConverterCalculatorOptions final :
 ...
 public:
  ...
  TfLiteConverterCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange* release_output_tensor_float_range();
  ...
  int32_t max_num_channels() const;
  void set_max_num_channels(int32_t value);
  private:
  int32_t _internal_max_num_channels() const;
  void _internal_set_max_num_channels(int32_t value);
  public:
...
inline int32_t TfLiteConverterCalculatorOptions::_internal_max_num_channels() const {
  return max_num_channels_;
}
inline int32_t TfLiteConverterCalculatorOptions::max_num_channels() const {
...
inline void TfLiteConverterCalculatorOptions::_internal_set_max_num_channels(int32_t value) {
  _has_bits_[0] |= 0x00000040u;
  max_num_channels_ = value;
}
inline void TfLiteConverterCalculatorOptions::set_max_num_channels(int32_t value) {
...
inline ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange* TfLiteConverterCalculatorOptions::_internal_mutable_output_tensor_float_range() {
  ...
  if (output_tensor_float_range_ == nullptr) {
    auto* p = CreateMaybeMessage<::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange>(GetArenaForAllocation());
...
inline ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange* TfLiteConverterCalculatorOptions::mutable_output_tensor_float_range() {
  ::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange* _msg = _internal_mutable_output_tensor_float_range();
...
inline void TfLiteConverterCalculatorOptions::set_allocated_output_tensor_float_range(::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange* output_tensor_float_range) {
  ...
  if (output_tensor_float_range) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mediapipe::TfLiteConverterCalculatorOptions_TensorFloatRange>::GetOwningArena(output_tensor_float_range);
