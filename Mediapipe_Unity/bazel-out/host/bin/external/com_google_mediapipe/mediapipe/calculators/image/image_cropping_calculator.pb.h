...
class ImageCroppingCalculatorOptions final :
 ...
 public:
  ...
  ImageCroppingCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  int32_t output_max_width() const;
  void set_output_max_width(int32_t value);
  private:
  int32_t _internal_output_max_width() const;
  void _internal_set_output_max_width(int32_t value);
  public:
  ...
  int32_t output_max_height() const;
  void set_output_max_height(int32_t value);
  private:
  int32_t _internal_output_max_height() const;
  void _internal_set_output_max_height(int32_t value);
  public:
 ...
 private:
  ...
  int32_t output_max_width_;
  int32_t output_max_height_;
  int border_mode_;
...
inline int32_t ImageCroppingCalculatorOptions::_internal_width() const {
  return width_;
}
inline int32_t ImageCroppingCalculatorOptions::width() const {
  // @@protoc_insertion_point(field_get:mediapipe.ImageCroppingCalculatorOptions.width)
  return _internal_width();
}
inline void ImageCroppingCalculatorOptions::_internal_set_width(int32_t value) {
  _has_bits_[0] |= 0x00000001u;
  width_ = value;
}
inline void ImageCroppingCalculatorOptions::set_width(int32_t value) {
...
inline int32_t ImageCroppingCalculatorOptions::_internal_height() const {
  return height_;
}
inline int32_t ImageCroppingCalculatorOptions::height() const {
  // @@protoc_insertion_point(field_get:mediapipe.ImageCroppingCalculatorOptions.height)
  return _internal_height();
}
inline void ImageCroppingCalculatorOptions::_internal_set_height(int32_t value) {
  _has_bits_[0] |= 0x00000002u;
  height_ = value;
}
inline void ImageCroppingCalculatorOptions::set_height(int32_t value) {
...
inline int32_t ImageCroppingCalculatorOptions::_internal_output_max_width() const {
  return output_max_width_;
}
inline int32_t ImageCroppingCalculatorOptions::output_max_width() const {
...
inline void ImageCroppingCalculatorOptions::_internal_set_output_max_width(int32_t value) {
  _has_bits_[0] |= 0x00000080u;
  output_max_width_ = value;
}
inline void ImageCroppingCalculatorOptions::set_output_max_width(int32_t value) {
...
inline int32_t ImageCroppingCalculatorOptions::_internal_output_max_height() const {
  return output_max_height_;
}
inline int32_t ImageCroppingCalculatorOptions::output_max_height() const {
...
inline void ImageCroppingCalculatorOptions::_internal_set_output_max_height(int32_t value) {
  _has_bits_[0] |= 0x00000100u;
  output_max_height_ = value;
}
inline void ImageCroppingCalculatorOptions::set_output_max_height(int32_t value) {
