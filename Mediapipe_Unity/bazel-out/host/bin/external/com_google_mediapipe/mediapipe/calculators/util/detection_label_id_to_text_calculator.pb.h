...
class DetectionLabelIdToTextCalculatorOptions final :
 ...
 public:
  ...
  DetectionLabelIdToTextCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
void DetectionLabelIdToTextCalculatorOptions::set_label_map_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
