...
const uint32_t TableStruct_mediapipe_2fcalculators_2fimage_2frecolor_5fcalculator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, -1, sizeof(::mediapipe::RecolorCalculatorOptions)},
};
...
inline void RecolorCalculatorOptions::SharedCtor() {
...
inline void RecolorCalculatorOptions::SharedDtor() {
...
uint8_t* RecolorCalculatorOptions::_InternalSerialize(
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RecolorCalculatorOptions::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    RecolorCalculatorOptions::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RecolorCalculatorOptions::GetClassData() const { return &_class_data_; }

void RecolorCalculatorOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<RecolorCalculatorOptions *>(to)->MergeFrom(
      static_cast<const RecolorCalculatorOptions &>(from));
}
